...
typedef struct
{
    ...
    int (*regsensorints)   ( void* gpin_data, unsigned int total_interrupt_sensors, void* sensor_itr ); 
    int (*unregsensorints)   ( void* gpin_data );
    int (*regchassisints)   (  void* gpin_data, unsigned int total_interrupt_sensors, void* sensor_itr ); 
...
extern unsigned int total_interrupt_sensors;
extern gpio_interrupt_sensor* intr_chassis;
extern unsigned int total_chassis_interrupts;
