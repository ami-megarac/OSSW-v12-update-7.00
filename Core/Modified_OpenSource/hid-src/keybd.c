...
SendKeybdData (uint8 DevNo,uint8 IfNum, uint8 *Buff)
{
	...
	/* Reason for false positive - KeybdQueue[IfNum].WaitForHostToReceiveKeybdData will be restored to 0 when next time SendKeybdData() called if LastKeybdEventTimeStamp[IfNum] time out. */
