...
SendMouseData (uint8 DevNo,uint8 IfNum, uint8 *Buff)
{
	...
	/* Reason for false positive - MouseQueue[IfNum].WaitForHostToReceiveMouseData will be restored to 0 when next time SendMouseData() called if LastMouseEventTimeStamp[IfNum] time out. */
	/* coverity[end_of_path : FALSE] */
