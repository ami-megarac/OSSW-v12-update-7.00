...
#endif
{
    ...
    snoop_irq = GetIrqFromDT("ami_snoop", SNOOP_IRQ_ADDR);
                                             

	if ((ret = request_irq(snoop_irq, snoop_hw_irq_handler, IRQF_SHARED, "snoop", (void*)("snoop_irq"))) != 0)
	{
...
#endif
{
	...
	if (sio_irq_requested)
        {
                free_irq (snoop_irq, (void*)("snoop_irq"));
                sio_irq_requested = 0;
        }
