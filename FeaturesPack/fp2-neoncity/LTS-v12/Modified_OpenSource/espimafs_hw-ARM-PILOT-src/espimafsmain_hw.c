...
int pilot_espimafs_init(void)
{
   ...
   espimafs_irq = GetIrqFromDT("pilot_espimafs", IRQ_ESPI_SAFS);
    if( request_irq( espimafs_irq, pilot_espimafs_handler, IRQF_SHARED, "pilot_espimafs", (pilot_espimafs_virt_base + PILOT_ESPI_FLASH_CHAN_ID)) < 0 )
    {
...
void pilot_espimafs_exit(void)
{
    ...
    free_irq(espimafs_irq, (pilot_espimafs_virt_base + PILOT_ESPI_FLASH_CHAN_ID));
